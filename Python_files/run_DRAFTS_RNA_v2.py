...
#    fadapter = "AAGCAGTGGTATCAACGCAGAGTACAT" # Adaptor sequence without "NN" at the end
    fadapter = "CGCAGAGTACAT" # Adaptor sequence without "NN" at the end
#    radapter = 'CTTAAGATTAAC' # UTR
    radapter = "GTGGTCCGGTCT" #upstream_UTR
...
#                     print('{}, {}, p{}'.format(prom,bc,len(prom)))
                    if sbc in sref_bc and len(prom) == 0:
                        ...
                        trim_prom = prom_lib[sbc][150-len(prom):]
